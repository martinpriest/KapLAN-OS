...
$userPermission->read();
// ZANEGUJ AKTUALNA WARTOSC
if($userPermission->getDeviceGroupPermission() == 1) $userPermission->setDeviceGroupPermission(0);
else $userPermission->setDeviceGroupPermission(1);
